...
const projects = [
  ...
  {
    title: "SkillBarter — Peer Learning",
  ...
  {
    title: "MoodTunes — AI Music Picker",
    desc: "Detects user mood from text input and curates Spotify playlists tailored to the vibe.",
    stack: ["React", "Spotify API", "OpenAI", "Tailwind"],
    tag: "AI / Product",
    gradient: "from-primary/30 to-accent/10",
    emoji: "🎧",
  },
  {
    title: "PersonaAI — Character Chatbox",
    desc: "Interactive AI chat app where users can choose virtual characters and have real-time conversations with unique personalities.",
  ...
  },
  {
    ...
    desc: "Plan multi-city itineraries with AI suggestions, packing lists and shared collaboration.",
    stack: ["Next.js", "Gemini API", "Mapbox", "Firebase"],
    tag: "AI / Full Stack",
      ...
      >
        ...
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a
              href="https://github.com/Nikhila-2604"
              target="_blank"
